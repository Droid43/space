<template>
  <div class="bg">
    <transition name="el-zoom-in-top">
      <div v-show="showQRcode" class="qr-code" ref="qrCodeDiv" @click="qrcodeClick"></div>
    </transition>
...
export default {
  ...
  methods: {
    ...
    updateQRcode () {
      ...
      if (isQrcodeCreated) return
      isQrcodeCreated = true
      this.$nextTick(() => {
        let url = 'https://open.weixin.qq.com/connect/oauth2/authorize?' +
            'appid=wx2538987e05854cee&' +
            'redirect_uri=' + encodeURIComponent('https://zenggen.xyz/network/author/action') +
